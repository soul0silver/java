...
public class ReadWriteObject {
    public static void main(String[] args) {
        Date currentDate = new Date(); //write object
        ...
        try {
            ...
            oos.writeObject(new Date()); System.out.println("Object writed!");
            oos.flush(); oos.close();
        } catch (Exception ex) { ex.printStackTrace(); }

        //read object
        ObjectInputStream ois = null;
        try { ois = new ObjectInputStream(new FileInputStream("object.dat"));
